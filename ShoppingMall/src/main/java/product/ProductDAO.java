...
public class ProductDAO {
	...
	// 탑3 뽑아오기
	/*
	 * public List<Product> top3(){ List<Product> results = jdbcTemplate.
	 ...
	 * 
	 * @Override public Product mapRow(ResultSet rs, int rowNum) throws
	 * SQLException { Product Product = new Product();
	 * Product.setP_CODE(rs.getString("P_CODE"));
	 * Product.setP_NAME(rs.getString("P_NAME"));
	 * Product.setP_IMAGE(rs.getString("P_IMAGE"));
	 * Product.setP_PRICE(rs.getInt("P_PRICE"));
	 * Product.setQty(rs.getInt("QTY")); return Product; } }); return results; }
	 */
}
