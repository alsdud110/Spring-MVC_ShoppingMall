	...
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4 w3-auto" style="width: 382px;height: 300.3px;">
			...
			<div class = "w3-center w3-large">
					<input type="submit" value = "아이디 찾기" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">
					...
					<button type="button" onclick="history.go(-1);" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">비밀번호 찾기</button>
			</div>
		</div>
	</div>	
</body>
