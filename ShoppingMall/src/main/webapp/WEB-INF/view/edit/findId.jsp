...
<body>
	<div class="w3-content w3-container w3-margin-top">
		<div class="w3-container w3-card-4 w3-auto" style="width: 382px;height: 300.3px;">
			...
			<div class = "w3-center w3-large w3-margin-top">
				<h2><%=session.getAttribute("findId") %></h2>
			</div>
			<br><br>
			<div class = "w3-center w3-large">
					...
					<button type="button" onclick="location.href = '<c:url value = '/findIdPassword'/>'" class="w3-button w3-hover-white w3-ripple w3-margin-top w3-round mybtn">비밀번호 찾기</button>
			</div>
		</div>
	</div>	
</body>
